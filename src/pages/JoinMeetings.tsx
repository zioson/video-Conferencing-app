...
//   const [createToast] = useToast();
          ...
          if (meeting.meetingType === "1-on-1") {
            if (meeting.invitedUsers[0] === user?.uid || isCreator) {
              if (meeting.meetingDate === moment().format("L")) {
                ...
                //   type: "warning",
                // });
                toast(` Meetings is on ${meeting.meetingDate} `);
            ...
            //     type: "danger",
            //   });
            toast(` You are not invited for this Mee `);
  ...
  const appid=1513585843;
  const serverSecret="05d05f2ac4683a0e727ac24407d1bc86"
